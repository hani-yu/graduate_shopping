...
=======
    ...
    function updateCountdowns() {
        $('.countdown').each(function() {
            const targetStr = $(this).data('time');
            ...
            $(this).html(`${hDisplay}:${mDisplay}:${sDisplay}`);
        });
    }
...
=======
    ...
    // if (noticeBoard) {
    //     $('.notice_item').css('opacity', '0'); // 初始化隐藏
    //     noticeObserver.observe(noticeBoard);
    // }
